        ...
        <View style={[globalStyles.view]}>
            <View style={globalStyles.column}>
                <View style={globalStyles.row}>
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Humanos'})}
                        buttonText="Humanos"
                        buttonIcon={require("../../../assets/icons/races/human.png")}
                    />
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Elfos'})}
                        buttonText="Elfos"
                        buttonIcon={require("../../../assets/icons/races/elf.png")}
                    />
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Anões'})}
                        buttonText="Anões"
                ...
                <View style={globalStyles.row}>
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Trolls'})}
                        buttonText="Trolls"
                        buttonIcon={require("../../../assets/icons/races/troll.png")}
                    />
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Gnomos'})}
                        buttonText="Gnomos"
                        buttonIcon={require("../../../assets/icons/races/gnome.png")}
                    />
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Orcs'})}
                        buttonText="Orcs"
                ...
                <View style={globalStyles.row}>
                    <SquareButton
                        onPress={() => navigation.navigate("Detalhes da Raça", {race: 'Ninfas'})}
                        buttonText="Ninfas"
